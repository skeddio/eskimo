...
package com.pialabs.eskimo.controls
{
	...
	public class SkinnableAlert extends SkinnableComponent
	{
		...
		private static var heightWindow:Number = 200;
		private static var fontSize:Number = 16;
		...
		public static function show(text:String = "", title:String = "", flags:uint = 0x4, 
									...
									height:Number = 200, _fontSize:int=16):SkinnableAlert
		{
		...
		protected override function measure():void
		{
			...
			measuredWidth = 300;
			measuredHeight = heightWindow;
			buttonOK.height = 40;
			buttonOK.setStyle("chromeColor", 0x333333); 
			buttonYES.height = 40;
			buttonYES.setStyle("chromeColor", 0x333333); 
			buttonCANCEL.height = 40;
			buttonCANCEL.setStyle("chromeColor", 0x333333); 
			buttonNO.height = 40;
			buttonNO.setStyle("chromeColor", 0x333333); 
			
			textDisplay.setStyle("fontSize", fontSize);
